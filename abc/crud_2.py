...
class FHIRCrud:
    ...
    def _create_fhir_json(self,all_insurance,all_gurantors,all_next_to_kin,patient):
        ...
        for ins_list in insurance_list:
            ...
            insurance_name = ins_list.get("Insurance")
            insurance_name = insurance_name.name if insurance_name else "Unknown"

            fhir_insurances = Coverage(
                id = f"cov-{ins_list['id']}",
                kind = "Insurance",
